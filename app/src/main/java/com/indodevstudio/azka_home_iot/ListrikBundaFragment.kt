...
class ListrikBundaFragment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_listrik_bunda, container, false)
        button = view.findViewById(R.id.status_btn)
        button_graph = view.findViewById(R.id.graph_btn)
        myWebView = view.findViewById(R.id.myWeb)
        Statustxt = view.findViewById(R.id.statusText)
        button.setOnClickListener(this)
        button_graph.setOnClickListener(this)
    ...
    override fun onClick(view: View?) {
        when(view?.id){
            R.id.status_btn-> {
                println("STATUS!")
                val URL : String ="https://abeazka.my.id/telemetri/input-wa.php?type=water02 &value1=listrik_bunda"
            ...
            R.id.graph_btn -> {
                if (click == true){
                    ...
                    click = true
                    println("STATUS!")
                    val URL: String = "https://abeazka.my.id/telemetri/listrikgrafikbunda.php"
                    if (URL.isNotEmpty()) {
                        val http = OkHttpClient()
                        val request = Request.Builder()
                            .url(URL)
                        ...
                        http.newCall(request).enqueue(object : Callback {
                            ...
                            override fun onResponse(call: Call, response: Response) {
                                ...
                                if (response.code == 200) {
                                    ...
                                    val URL2 =
                                        URL("https://abeazka.my.id/telemetri/listrik/grafiklistrik_bunda-x.php.png")
                                    try {
