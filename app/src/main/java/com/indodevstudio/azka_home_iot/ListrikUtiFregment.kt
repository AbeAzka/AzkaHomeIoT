...
class ListrikUtiFregment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_listrik_uti_fregment, container, false)
        ...
        when(view?.id){
            ...
            R.id.graph_btn -> {
                if (click == true){
                    ...
                    click = true
                    println("STATUS!")
                    val URL: String = "https://abeazka.my.id/telemetri/listrikgrafikuti.php"
                    if (URL.isNotEmpty()) {
                        val http = OkHttpClient()
                        val request = Request.Builder()
                            .url(URL)
                        ...
                        http.newCall(request).enqueue(object : Callback {
                            ...
                            override fun onResponse(call: Call, response: Response) {
                                ...
                                if (response.code == 200) {
                                    ...
                                    val URL2 =
                                        URL("https://abeazka.my.id/telemetri/listrik/grafiklistrik_uti-x.php.png")
                                    try {
