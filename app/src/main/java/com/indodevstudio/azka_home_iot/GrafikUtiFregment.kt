...
class GrafikUtiFregment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_grafik_uti_fregment, container, false)
                    ...
                    http.newCall(request).enqueue(object : Callback {
                        ...
                        override fun onResponse(call: Call, response: Response) {
                            ...
                            if (response.code == 200) {
                                ...
                                val URL2 = URL( "https://abeazka.my.id/telemetri/tandon/grafiktandon_uti-x.php.png")
                                try{
