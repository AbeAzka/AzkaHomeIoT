...
class TandonBundaFragment : Fragment(), View.OnClickListener{
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_tandon_bunda, container, false)
